...
\begin{figure}[H]
	...
	\flushleft\quad\quad\footnotesize{Source: Own Model User Interface}
\end{figure}	
This is conducted quite succesfully, as autarky remains high, at 94 percent. Electricity from the grid is only imported during the winter period (see fig. 11). The model still does not construct any storage.
